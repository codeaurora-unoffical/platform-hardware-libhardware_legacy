...
public:
    ...
    enum audio_devices {
        ...
        DEVICE_OUT_ALL = (DEVICE_OUT_EARPIECE | DEVICE_OUT_SPEAKER | DEVICE_OUT_WIRED_HEADSET |
                ...
                DEVICE_OUT_FM | DEVICE_OUT_FM_TX | DEVICE_OUT_PROXY |
                DEVICE_OUT_DEFAULT),
        ...
        DEVICE_IN_ALL = (DEVICE_IN_COMMUNICATION | DEVICE_IN_AMBIENT | DEVICE_IN_BUILTIN_MIC |
                ...
                DEVICE_IN_VOICE_CALL | DEVICE_IN_BACK_MIC | DEVICE_IN_FM_RX |
                DEVICE_IN_FM_RX_A2DP | DEVICE_IN_PROXY | DEVICE_IN_DEFAULT)
    };
