...
const struct StringToEnum sFormatNameToEnumTable[] = {
    ...
    STRING_TO_ENUM(AUDIO_FORMAT_PCM_24_BIT),
    STRING_TO_ENUM(AUDIO_FORMAT_PCM_16_BIT_TE),
    STRING_TO_ENUM(AUDIO_FORMAT_PCM_24_BIT_TE),
    STRING_TO_ENUM(AUDIO_FORMAT_PCM_8_BIT),
    STRING_TO_ENUM(AUDIO_FORMAT_MP3),
    STRING_TO_ENUM(AUDIO_FORMAT_AAC),
    STRING_TO_ENUM(AUDIO_FORMAT_VORBIS),
    STRING_TO_ENUM(AUDIO_FORMAT_AC3),
    STRING_TO_ENUM(AUDIO_FORMAT_AC3_DM),
    STRING_TO_ENUM(AUDIO_FORMAT_EAC3),
    STRING_TO_ENUM(AUDIO_FORMAT_EAC3_DM),
    STRING_TO_ENUM(AUDIO_FORMAT_DTS),
    STRING_TO_ENUM(AUDIO_FORMAT_DTS_LBR),
    STRING_TO_ENUM(AUDIO_FORMAT_DTS_TE),
    STRING_TO_ENUM(AUDIO_FORMAT_DTS_LBR_TE),
...
const struct StringToEnum sOutChannelsNameToEnumTable[] = {
    ...
    STRING_TO_ENUM(AUDIO_CHANNEL_OUT_3POINT1),
    STRING_TO_ENUM(AUDIO_CHANNEL_OUT_2POINT1),
    STRING_TO_ENUM(AUDIO_CHANNEL_OUT_4POINT1),
    STRING_TO_ENUM(AUDIO_CHANNEL_OUT_TRI),
    STRING_TO_ENUM(AUDIO_CHANNEL_OUT_6POINT0),
    STRING_TO_ENUM(AUDIO_CHANNEL_OUT_7POINT0),
    STRING_TO_ENUM(AUDIO_CHANNEL_OUT_8POINT0),
};
